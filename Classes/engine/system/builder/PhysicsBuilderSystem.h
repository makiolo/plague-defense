...
struct PhysicsBuilderSystem : public entityx::System<PhysicsBuilderSystem>
{
	...
	{
		es.each<plague::Transform, plague::Sprite2DComponent, plague::PhysicsDescription, plague::PhysicsIntrospectionComponent>([&](entityx::Entity entity, plague::Transform& transform, plague::Sprite2DComponent& sprite, plague::PhysicsDescription& physics_desc, plague::PhysicsIntrospectionComponent& introspection)
		{
